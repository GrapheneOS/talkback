...
{
  .name = "REFRESH",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_REFRESH)
},
{
  .name = "INDICATORS",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_INDICATORS)
},
{
  .name = "TXTSEL_CLEAR",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_TXTSEL_CLEAR)
},
{
  .name = "TXTSEL_ALL",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_TXTSEL_ALL)
},
{
  .name = "HOST_COPY",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_HOST_COPY)
},
{
  .name = "HOST_CUT",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_HOST_CUT)
},
{
  .name = "HOST_PASTE",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_HOST_PASTE)
},
{
  .name = "GUI_TITLE",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_TITLE)
},
{
  .name = "GUI_BRL_ACTIONS",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_BRL_ACTIONS)
},
{
  .name = "GUI_HOME",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_HOME)
},
{
  .name = "GUI_BACK",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_BACK)
},
{
  .name = "GUI_DEV_SETTINGS",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_DEV_SETTINGS)
},
{
  .name = "GUI_DEV_OPTIONS",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_DEV_OPTIONS)
},
{
  .name = "GUI_APP_LIST",
...
{
  .name = "GUI_APP_MENU",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_APP_MENU)
},
{
  .name = "GUI_APP_ALERTS",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_APP_ALERTS)
},
{
  .name = "GUI_AREA_ACTV",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_AREA_ACTV)
},
{
  .name = "GUI_AREA_PREV",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_AREA_PREV)
},
{
  .name = "GUI_AREA_NEXT",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_AREA_NEXT)
},
{
  .name = "GUI_ITEM_FRST",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_ITEM_FRST)
},
{
  .name = "GUI_ITEM_PREV",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_ITEM_PREV)
},
{
  .name = "GUI_ITEM_NEXT",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_ITEM_NEXT)
},
{
  .name = "GUI_ITEM_LAST",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_ITEM_LAST)
},
{
  .name = "SAY_LOWER",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_SAY_LOWER)
},
{
  .name = "SAY_HIGHER",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_SAY_HIGHER)
},
{
  .name = "SAY_ALL",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_SAY_ALL)
},
{
  .name = "CONTRACTED",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_CONTRACTED)
},
{
  .name = "COMPBRL6",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_COMPBRL6)
},
{
  .name = "PREFRESET",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_PREFRESET)
},
{
  .name = "ASPK_EMP_LINE",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_ASPK_EMP_LINE)
},
{
  .name = "SPK_PUNCT_LEVEL",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_SPK_PUNCT_LEVEL)
},
{
  .name = "PASTE_ALTMODE",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_PASTE_ALTMODE)
},
{
  .name = "SPEAK_CURR_PWRD",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_SPEAK_CURR_PWRD)
},
{
  .name = "SPEAK_PREV_PWRD",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_SPEAK_PREV_PWRD)
},
{
  .name = "SPEAK_NEXT_PWRD",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_SPEAK_NEXT_PWRD)
},
{
  .name = "SPELL_CURR_PWRD",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_SPELL_CURR_PWRD)
},
{
  .name = "SPELL_CURR_LINE",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_SPELL_CURR_LINE)
},
{
  .name = "CLIP_CLEAR",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_CLIP_CLEAR)
},
{
  .name = "CLIP_SHOW",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_CLIP_SHOW)
},
{
  .name = "ROUTE",
...
{
  .name = "ROUTE_LINE",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_ROUTE_LINE)
},
{
  .name = "REFRESH_LINE",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_REFRESH_LINE)
},
{
  .name = "TXTSEL_START",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_TXTSEL_START)
},
{
  .name = "TXTSEL_SET",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_TXTSEL_SET)
},
{
  .name = "ROUTE_SPEECH",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_ROUTE_SPEECH)
},
{
  .name = "PASTE_HISTORY_ALTMODE",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_PASTE_HISTORY_ALTMODE)
},
{
  .name = "SELECTVT",
...
{
  .name = "COLOR",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_COLOR)
},
{
  .name = "COPY_SMART_NEW",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_COPY_SMART_NEW)
},
{
  .name = "COPY_SMART_ADD",
  .code = (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_COPY_SMART_ADD)
},
{
  .name = "LINEFEED",
